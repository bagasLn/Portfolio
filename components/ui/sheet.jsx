  ...
  "fixed z-50 gap-4 bg-primary p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-slate-950",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-3/4 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm bg-black", /* backdrop-blur-lg bg-white/30 NAH DISINI UNTUK EDIT SIDE BAR KANAN JADI WAN ATAU BLUR ATAU TRANSPARANT*/
      },
    },
    defaultVariants: {
      side: "right",
